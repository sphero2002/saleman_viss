...
// @mui
import { Box, Stack, Button, Avatar, Divider, ListItem, TextField, Typography } from '@mui/material';
// utils
  ...
  return (
    <>
      ...
      >
        ...
        {!hasReply && (
          <Button size="small" onClick={() => setOpenReply(!openReply)} sx={{ right: 0, position: 'absolute' }}>
            Reply
          </Button>
        )}
      </ListItem>
