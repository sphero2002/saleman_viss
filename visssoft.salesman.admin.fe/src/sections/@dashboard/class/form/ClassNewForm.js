...
export default function ClassNewForm({ isEdit = false, currentClass, onNextStep, setFormData, setFormDataStepOne, formDataStepOne }) {
        ...
        if (!isEdit) {
            ...
            try {
                ...
                if (res.status < 400) {
                    ...
                    setTimeout(() => {
                        push(PATH_DASHBOARD.class.detail(res.data.data.id));
                    }, "2000")
