...
namespace VissSoft.SalesMan.Admin.DataAccessLayer.Data
{
    public partial class DataContext : DbContext
    {
        ...
        public DataContext(DbContextOptions<DataContext> options, IConfiguration config, IHttpContextAccessor httpContextAccessor)
            : base(options)
        {
